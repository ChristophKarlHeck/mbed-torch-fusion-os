...
cmake                                                  \
    ...
    -DEXECUTORCH_SELECT_OPS_LIST="aten::convolution.out,aten::relu.out,aten::unsqueeze_copy.out,aten::view_copy.out,aten::max_pool2d_with_indices.out,aten::squeeze_copy.dims_out,executorch_prim::et_view.default,aten::permute_copy.out,aten::addmm.out,aten::_softmax.out"  \
